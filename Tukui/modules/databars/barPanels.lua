...
T.databars["toggle"]:CreatePanel("ThickTransparent", pWidth+4, C.databars.settings.height, "TOP", T.databars[T.maxDatabars], "BOTTOM", 0, -(C.databars.settings.spacing+2))
