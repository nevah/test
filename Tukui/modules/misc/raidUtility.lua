	...
	if addon == "Tukui_Raid_Healing" or addon == "Tukui_Raid" then
		...
		local function CreateButton(name, parent, template, width, height, point, relativeto, point2, xOfs, yOfs, text, texture)
			...
			if text then
				...
				t:SetFont(C.datatext.font, C.datatext.fontsize)
				t:SetPoint("CENTER")
		...
		--Show Button
		CreateButton("TukuiRaidUtilityShowButton", UIParent, "UIMenuButtonStretchTemplate, SecureHandlerClickTemplate", TukuiMinimap:GetWidth(), 21, "TOPLEFT", anchor, "TOPLEFT", 0 , 0, RAID_ASSISTANT, nil)
		...
		TukuiRaidUtilityShowButton:CreateShadow("")
		...
		TukuiRaidUtilityCloseButton:CreateShadow("")
