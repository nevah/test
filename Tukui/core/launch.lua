...
v.Text:SetPoint("TOP", 0, -6)
v.Text:SetText("Tukui ".. T.version)
v:FontString("Text2", C.media.font, 12)
v.Text2:SetPoint("BOTTOM", 0, 6)
...
local fv = CreateFrame("Frame", nil, f)
fv:Point("TOPLEFT", f, "BOTTOMLEFT", 0, -3)
fv:Point("TOPRIGHT", f, "BOTTOMRIGHT", 0, -3)
fv:Height(18)
fv:SetTemplate("")
fv:CreateShadow("")
fv.text = fv:CreateFontString(nil, "OVERLAY")
fv.text:SetFont([[Interface\AddOns\Tukui\medias\fonts\uf_font.ttf]], 8)
fv.text:SetAllPoints(fv)
fv.text:SetText("|cff7A7A7A"..T.version)
